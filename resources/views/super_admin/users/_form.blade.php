    ...
    <div class="row no-gutters">
        ...
        <div class="col-lg-8 card-form__body card-body">
            ...
            <div class="row">
                <div class="col">
                    <div class="form-group required">
                        ...
                        <input name="company_name" type="text" class="form-control" placeholder="{{ __('messages.company_name') }}" value="{{ isset($company->name) ? $company->name : '' }}" required>
                    </div>
                </div>
            </div>
                ...
                <div class="col">
                    <div class="form-group required">
                        ...
                        <select name="role"  class="form-control" required>
                            <option value="admin" {{ $user->hasRole('admin') ? 'selected=""' : ''}}>User</option>
            ...
            <div class="row">
                <div class="col">
                    <div class="form-group required">
                        <label for="company_settings[withdraw_limit]">{{ __('messages.feature_withdraw_limit') }}</label>
                        <input name="company_settings[withdraw_limit]" type="number" class="form-control" value="{{ $withdraw_limit }}" required>
            ...
            <div class="row">
                <div class="col">
                    <div class="form-group required">
                        <label for="company_settings[withdraw_fixed_fee]">{{ __('messages.feature_withdraw_fixed_fee') }}</label>
                        <input name="company_settings[withdraw_fixed_fee]" type="number" class="form-control" value="{{ $withdraw_fixed_fee }}" required>
                        <small class="form-text text-muted">{{ __('messages.plan_feature_disable_helper') }}</small>
                    </div>
                </div>
                <div class="col">
                    <div class="form-group required">
                        <label for="company_settings[withdraw_percent_fee]">{{ __('messages.feature_withdraw_percent_fee') }}</label>
                        <input name="company_settings[withdraw_percent_fee]" type="number" class="form-control" value="{{ $withdraw_percent_fee }}" required>
                        <small class="form-text text-muted">{{ __('messages.plan_feature_disable_helper') }}</small>
                    </div>
                </div> 
            </div> 
            ...
            <div class="row">
                <div class="col">
                    <div class="form-group required">
                        <label for="company_settings[online_payment_fixed_fee]">{{ __('messages.feature_online_payment_fixed_fee') }}</label>
                        <input name="company_settings[online_payment_fixed_fee]" type="number" class="form-control" value="{{ $online_payment_fixed_fee }}" required>
                        <small class="form-text text-muted">{{ __('messages.plan_feature_disable_helper') }}</small>
                    </div>
                </div> 
                <div class="col">
                    <div class="form-group required">
                        <label for="company_settings[online_payment_percent_fee]">{{ __('messages.feature_online_payment_percent_fee') }}</label>
                        <input name="company_settings[online_payment_percent_fee]" type="number" class="form-control" value="{{ $online_payment_percent_fee }}" required>
                        <small class="form-text text-muted">{{ __('messages.plan_feature_disable_helper') }}</small>
                    </div>
                </div> 
            </div> 
