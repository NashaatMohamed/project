            ...
            @foreach ($products as $product)
                <tr>
                    ...
                    <td class="text-center">
                        ...
                        <a href="{{ route('products.show.first.variation', ['product' => $product->id, 'company_uid' => $currentCompany->uid]) }}" class="btn btn-sm btn-link" data-toggle="tooltip" title="{{ __('messages.view_first_variation') }}">
