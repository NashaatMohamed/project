@foreach([
       'AliceBlue', 'Amethyst', 'AntiqueWhite', 'Aqua', 'Aquamarine', 'Azure', 'Beige', 'Bisque', 'Black', 'BlanchedAlmond',
    ...
    <option value="{{ $color }}" data-color="{{ trans('messages.' . $color) }}" {{ isset($product->colors[$color]) ? 'selected' : '' }}>
