                ...
                <div class="row no-gutters">
                    <div class="col card-form__body card-body bg-white">
                        ...
                        <div class="form-row align-items-center mb-4">
                            <div class="col">
                                <p class="h5 mb-0">
                                    <strong class="headings-color">{{ __('messages.product_brands') }}</strong>
                                </p>
                            </div>
                            <div class="col-auto">
                                <a href="{{ route('settings.product.brand.create', ['company_uid' => $currentCompany->uid]) }}" class="btn btn-light">
                                    <i class="material-icons icon-16pt">add</i>
                                    {{ __('messages.add_product_brand') }}
                                </a>
                            </div>
                        </div>

                        @include('application.settings.product.brand._table')
                ...
                <div class="row no-gutters">
                    <div class="col card-form__body card-body bg-white">
                        ...
                        <div class="form-row align-items-center mb-4">
                            <div class="col">
                                <p class="h5 mb-0">
                                    <strong class="headings-color">{{ __('messages.product_categories') }}</strong>
                                </p>
                            </div>
                            <div class="col-auto">
                                <a href="{{ route('settings.product.category.create', ['company_uid' => $currentCompany->uid]) }}" class="btn btn-light">
                                    <i class="material-icons icon-16pt">add</i>
                                    {{ __('messages.add_product_category') }}
                                </a>
                            </div>
                        </div>

                        @include('application.settings.product.category._table')
