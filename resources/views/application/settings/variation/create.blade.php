<!-- resources/views/application/settings/variation/create.blade.php -->

@extends('layouts.app', ['page' => 'settings'])

@section('title', __('messages.add_variation'))
...
@section('content')
    <div class="page__heading">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0">
                ...
                <li class="breadcrumb-item active" aria-current="page">{{ __('messages.add_variation') }}</li>
            </ol>
        </nav>
        <h1 class="m-0">{{ __('messages.add_variation') }}</h1>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-lg-9">
            <form action="{{ route('settings.variation.store', ['company_uid' => $currentCompany->uid]) }}" method="POST">
                ...
                <div class="card card-form">
                    <div class="card-body bg-white">
                        <div class="form-row align-items-center mb-4">
                            <div class="col">
                                <p class="h4 mb-0">
                                    <strong class="headings-color">{{ __('messages.add_variation') }}</strong>
                                </p>
                            </div>
                        </div>
                ...
                <div class="form-group text-right mt-4">
                    <button type="submit" class="btn btn-primary">{{ __('messages.add_variation') }}</button>
                </div>
