...
@section('content')
    ...
    <div class="row card-group-row pt-2">
        <div id="payment_options" class="col-12">
            @if (\App\Models\SystemSetting::isPaymobActive() and $plan->currency == 'EGP')
                <div class="card">
                    <div class="card-header" id="paymob">
                        <h5 class="my-2">
                            {{ __('messages.choose_payment_option') }} 
                        </h5>
                    </div>

                    <div id="paymob" class="collapse show">
                        <div class="card-body">
                            <div class="row">
                                @if (\App\Models\SystemSetting::isPaymobCreditCardActive())
                                    <div class="col text-center">
                                        <i class="material-icons">payment</i> 
                                        <a class="dropdown-item" href="{{ route('order.payment.paymob', [
                                            'plan' => $plan->slug,
