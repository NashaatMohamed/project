                ...
                <div class="card card-group-row__card pricing__card">
                    <div class="card-body d-flex flex-column">
                        ...
                        <div class="card-body d-flex flex-column">
                            ...
                            @if($plan->hasTrial() && filled($currentCompany) && !$currentCompany->subscriptions->isNotEmpty())
                            ...
                            @else
                                <a href="{{ route('order.checkout', ['company_uid' => filled($currentCompany) ?  $currentCompany->uid : null, 'plan' => $plan->slug]) }}" class="btn btn-success mt-auto">{{ __('messages.purchase') }}</a>
                            @endif
                        </div>
                    </div>
                </div>
