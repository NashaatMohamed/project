            ...
            <div class="row">
                <div class="col">
                    <div class="form-group required">
                        ...
                        <select id="billing[country_id]" name="billing[country_id]" autocomplete="off" data-toggle="select" class="form-control select2-hidden-accessible" data-select2-id="billing[country_id]" required>
                            <option disabled selected>{{ __('messages.select_country') }}</option>
                            @foreach(get_countries_select2_array() as $option)
                                <option value="{{ $option['id'] }}" {{ ($customer->billing->country_id == $option['id'] || ($customer->billing->country_id == null && $option['code'] == 'EG')) ? 'selected=""' : '' }}>{{ $option['text'] }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col">
                    <div class="form-group">
                        ...
                        <select id="shipping[country_id]" name="shipping[country_id]" autocomplete="off" data-toggle="select" class="form-control select2-hidden-accessible" data-select2-id="shipping[country_id]">
                            <option disabled selected>{{ __('messages.select_country') }}</option>
                            @foreach(get_countries_select2_array() as $option)
                                <option value="{{ $option['id'] }}" {{ ($customer->shipping->country_id == $option['id'] || ($customer->shipping->country_id == null && $option['code'] == 'EG')) ? 'selected=""' : '' }}>{{ $option['text'] }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
