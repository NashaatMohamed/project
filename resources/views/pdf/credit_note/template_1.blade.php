...
<body>
        ...
        <table width="100%">
            <tr>
                <td class="text-center">
                    ...
                    @else
                        <h2 class="header-logo">{{$credit_note->company->name}}</h2>
                    @endif
                </td>
            </tr>
        </table>
    ...
    <div class="content-wrapper">
        <div style="padding-top: 30px">
            ...
            <div class="credit_note-details-container">
                <table>
                    <tr>
                        <td class="attribute-label">{{ __('messages.credit_note_number') }}</td>
                        <td class="attribute-value"> &nbsp;{{$credit_note->credit_note_number}}</td>
                    </tr>
                    <tr>
                        <td class="attribute-label">{{ __('messages.credit_note_date') }}</td>
                        <td class="attribute-value"> &nbsp;{{$credit_note->formatted_credit_note_date}}</td>
                    </tr>
                </table>
            </div>
        ...
        <div class="shipping-address-container shipping-address" @if($credit_note->customer->shipping->address_1) style="float:left;" @else style="display:block; float:left: padding-left: 0px;" @endif>
