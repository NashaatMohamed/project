...
class UserController extends Controller
{
    ...
    public function create(Request $request)
    {
        ...
        $commissions = $userCompany->getCommissions();
        ...
        return view('super_admin.users.create', [
            'user' => $user,
            'company' => $userCompany,
            'withdraw_limit' => $commissions['withdraw_limit'],
            'withdraw_fixed_fee' => $commissions['withdraw_fixed_fee'],
            'withdraw_percent_fee' => $commissions['withdraw_percent_fee'],
            'online_payment_fixed_fee' => $commissions['online_payment_fixed_fee'],
            'online_payment_percent_fee' => $commissions['online_payment_percent_fee']
        ]);
    }
    ...
    public function store(Store $request)
    {
        ...
        foreach ($request->company_settings as $setting => $value) {
            $userCompany->setSetting($setting, $value);
        }
