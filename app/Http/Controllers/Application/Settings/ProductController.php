...
class ProductController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $product_brands = ProductBrands::findByCompany($currentCompany->id)->paginate(15);
        $product_categories = ProductCategories::findByCompany($currentCompany->id)->paginate(15);
